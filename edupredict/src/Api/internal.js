...
export const quiz_summary = async () => {
  let response;
  try {
    response = await api.get(`/quiz-summary`);
  } catch (error) {
    return error;
  }
  return response;
...
export const teacher_analysis = async () => {
  let response;
  try {
...
export const academic_performance = async () => {
  let response;
  try {
    response = await api.get(`/academic-performance`);
  } catch (error) {
    return error;
  }
  return response;
