...
function TeacherAssignment() {
    ...
    const handleDownload = () => {
      if (filteredData.length > 0) {
        downloadCSV(filteredData, "Assignment_Analytics.csv");
      } else {
        downloadCSV(analytics, "Assignment_All.csv");
      }
    };
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-2 items-start sm:items-center mb-4">
              ...
              <h1 className="text-xl md:text-2xl font-semibold text-gray-800">
                  Monthly Assignment Performance
                </h1>
            ...
            <div className="h-[300px] md:h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                        ...
                        return (
                          <div className="bg-white border shadow p-2 rounded text-sm text-gray-700">
                            ...
                            <p className="font-semibold">
                              Course: {payload[0].payload.course}
                            </p>
                            <p>Total assignments: {payload[0].payload.avg_assignments}</p>
                          </div>
                        );
                      }
                      return null;
                ...
                <p className="text-center text-gray-500 mt-10">
                  ⚠ No assignment data available for this teacher
                </p>
              )}
          </div>
  ...
  <p className="text-gray-600 mb-6">Total assignments completed</p>
